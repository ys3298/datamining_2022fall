...
For classification problem, likelihood function is $L = -y_ilog(p_i) + (1-y_i)log(1-p_i)$, the gradient of loss function is $g_i = -(y_i-p_i)$ and the Hession function is $h_i = p_i * (1-p_i)$.
